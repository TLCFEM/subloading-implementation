...
Compared to the recent work \citep[e.g.,][]{Hashiguchi2018}, here we have presented an equivalent but simpler approach to compute the starting normal yield ratio for arbitrary loading increments.
